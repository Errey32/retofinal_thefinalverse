...
sleep(delay)
FightSystem(lang).start(Enemy('flameguy'))
system("cls")
...
sleep(delay)
FightSystem(lang).start(Enemy('fallenangel'))
system("cls")
...
sleep(delay)
print("You got out of the house and some skeletons are waiting for you, Defeat them")
FightSystem(lang).start(Enemy('skeletons'))
system("cls")
...
sleep(delay)
FightSystem(lang).start(Enemy('goblin'))       
system("cls")
...
FightSystem(lang).start(Enemy('eldenghost'))
system("cls")
